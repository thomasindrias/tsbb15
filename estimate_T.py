...
def estimate_T(Jgdx, Jgdy, x, y, window_size):
    ...
    T = np.zeros((window_size[1], window_size[0], 2, 2))
    ...
    T[:, :, 0, 0] = Jgdx_windowed*Jgdx_windowed
    T[:, :, 0, 1] = Jgdx_windowed*Jgdy_windowed
    T[:, :, 1, 0] = Jgdy_windowed*Jgdx_windowed
    T[:, :, 1, 1] = Jgdy_windowed*Jgdy_windowed
    return T
